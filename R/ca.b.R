...
CAClass <- if (requireNamespace('jmvcore')) R6::R6Class(
    ...
    #### Init + run functions ----
      ...
      .init = function() {
            ...
            the associations between categorical variables in a contingency table. It is often applied to explore and visualize 
            ...
            relationships between two categorical variables.</p>

            <p> While the <I>Active Columns</I> field is mandatory, the <I>Supplementary Columns</I> field is optional. 
